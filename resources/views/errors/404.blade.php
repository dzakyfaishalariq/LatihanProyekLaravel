            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="company_detail">
                        ...
                        <h3>PAGE NOT F<i class="zmdi zmdi-mood-bad"></i>UND</h3>
                ...
                <div class="col-lg-5 col-md-12 offset-lg-1">
                    <div class="card-plain">
                        ...
                        <div class="footer">
                            <a href="{{ route('login') }}" class="btn btn-primary btn-round btn-block">Back To Home</a>                            
                        </div>
